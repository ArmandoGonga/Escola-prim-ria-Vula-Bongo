                            ...
                            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 " >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <input type="text" class="input-xs form-control in" id="bairro" name="bairro" maxlength="100" value="<?=$rs['bairro']; ?>" placeholder="Municipio" required="">

                                    </div>

                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        <label>Bairro</label>
                                        <input type="text" class="input-xs form-control in" id="quarteirao" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="quarteirao" value="<?=$rs['quarteirao']; ?>" placeholder="Bairro">
                                    </div>
