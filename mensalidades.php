                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="" readonly="" style="border: 0;" size="5" id="ganhos_mensal" value="" name=""><?=number_format($administracao->coleta_mes('Ago'),2);?> Akz</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_ano(),2); ?>  Akz</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_mensalidades(),2); ?> Akz</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id=""><input type="" readonly="" style="border: 0;" size="5" id="ganhos_anual" value="" name=""><?=number_format($administracao->coleta_mensalidades()+$administracao->coleta_ano(),2); ?> Akz</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                  ...
                  while($linhas = mysqli_fetch_array($resultado)){
                    echo "<tr>";
                      ...
                      <td><?php if(empty($Est['Fev'])){ ?>
                          ...
                          <button type="button" href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-whatever1="Fev" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                      ...
                      <td><?php if(empty($Est['Mar'])){ ?>
                          ...
                          <button type="button" <?php if(empty($Est['Fev'])){ ?> disabled="" <?php } ?>  href="#fazerPagamento"  class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Mar" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                      ...
                      <td><?php if(empty($Est['Abr'])){ ?>
                          ...
                          <button type="button" <?php if(empty($Est['Mar'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Abr" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                      ...
                      <td><?php if(empty($Est['Mai'])){ ?>
                          ...
                          <button type="button" <?php if(empty($Est['Abr'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Mai" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                        ...
                        <?php } ?>
                          ...
                          <button type="button" <?php if(empty($Est['Mai'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Jun" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                        ...
                        <?php } ?>
                          ...
                          <button type="button" <?php if(empty($Est['Jun'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Jul" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                      ...
                      <td><?php if(empty($Est['Ago'])){ ?>
                          ...
                          <button type="button" <?php if(empty($Est['Jul'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Ago" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                      ...
                      <td><?php if(empty($Est['Sete'])){ ?>
                          ...
                          <button type="button" <?php if(empty($Est['Ago'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Sete" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
                        ...
                        <?php } ?>
                          ...
                          <button type="button" <?php if(empty($Est['Outu'])){ ?> disabled="" <?php } ?> href="#fazerPagamento" class="btn btn-xs btn-danger btn-block" data-whatever3="<?php echo $linhas['nome_aluno'];?>" data-toggle="modal" data-whatever="<?php echo $linhas['nr_aluno'];?>" data-whatever1="Nov" data-whatever2=""><i data-toggle="tooltip" title="Fazer pagamento"></i><b>x</b></button>
