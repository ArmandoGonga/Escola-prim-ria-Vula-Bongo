                            ...
                            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 " >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                        ...
                                        <input type="text" autofocus="" readonly="" class="input-xs form-control in " name="nr_professor" id="nr_professor" maxlength="20" data-validate="Este campo é obrigatório" value="<?=$rs['idprofessor']; ?>" placeholder="Nº do Professor" required="" >
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="local_de_emissao" required="">
                                            ...
                                            <option <?=($rs['local_de_emissao'] == "Viana" ? "selected": ''); ?> value="Viana" >Viana</option> 
                                            ...
                                            <option <?=($rs['local_de_emissao'] == "Zango" ? "selected": ''); ?> value="Zango" >Zango</option> 
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <input type="text" class="input-xs form-control in" id="validade" min="<?=$validade_min; ?>" max="<?=$validade_max; ?>" name="validade_documento_inicial_professor" value="<?=$rs['validade_documento']; ?>" placeholder="Documento Validade " onfocus="(this.type = 'date')" required="">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="nacionalidade_professor" required="">
                                            ...
                                            <option <?=($rs['nacionalidade_professor'] == "Congolesa" ? "selected": ''); ?> value="Congolesa">Congolesa</option>
