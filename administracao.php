            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <a href="funcionarios.php" title="">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><?=utf8_encode("Funcionarios")  ?></div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <a href="usuarios.php" title="">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><?=utf8_encode("Usuarios")  ?></div>
