                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="local_de_emissao" required="">
                                            ...
                                            <option value="Maputo" >Cabinda</option> 
                                            <option value="Matola" >Kwanza Sul</option> 
                                            <option value="Gaza" >Kwanza Norte</option>
                                            <option value="Inhambane" >Namibe</option> 
                                            <option value="Quelimane" >Malanje</option> 
                                            <option value="Tete" >Uíge</option> 
                                            <option value="Nampula" >Hambo</option>
                                            <option value="Lichinga" >Lunda Sul</option> 
                                            <option value="Pemba" >Outra...</option>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="nacionalidade_aluno" required="">
                                            ...
                                            <option value="Sul Africana">Outra</option>
