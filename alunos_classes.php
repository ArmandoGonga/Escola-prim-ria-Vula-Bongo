...
?>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">#DISCIPLINA: <?= $administracao->pega_dados_professor('d.nome_disciplina', 'nome_disciplina', $_SESSION['f_key'], $q); ?> </h1>
        </div>
        <h4 class='m-0 font-weight-bold text-primary'><?= $administracao->pega_dados_professor('c.nome_classe', 'nome_classe', $_SESSION['f_key'], $q); ?> - <?= $administracao->pega_tudo('nome_turma','turma', 'nr_turma' , $q); ?></h4>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <tbody id="searchable" class="searchable">
                    <?php
                        echo $aluno->listar_alunos_turmas($q);
                    ?>
